...
<body>
    ...
    <div class="login-container">
        <div class="login-header">
            ...
            <h2>For My Love</h2>
            <p>Enter our special code to continue</p>
        </div>

        <form method="POST" action="">
            <div class="mb-3">
                <input type="password" class="form-control" name="pin" placeholder="Enter PIN" maxlength="4" inputmode="numeric" pattern="\d*" required>
            </div>
            <button type="submit" class="btn btn-login">Unlock Our Memories</button>
    ...
    <script>
        // Make PIN input more user-friendly
